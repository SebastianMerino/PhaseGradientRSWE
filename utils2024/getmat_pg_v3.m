function [Ax_large, Az_large, bx_large, bz_large, size_out] = getmat_pg_v3(u, w_kernel, dinf, og_size, stride)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    Az_large = kron(speye(numSubMatrices), Az_small);
    bz_large = zeros(numSubMatrices*numRows, 1); 
    Ax_large = kron(speye(numSubMatrices), Ax_small);
    bx_large = bz_large;
    ...
    elemA = reshape(1:2*numSubMatrices,[2,numSubMatrices]);
    elemA = elemA';
    icolA = elemA(:);
